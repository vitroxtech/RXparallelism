...
public class SectionedListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder sectionViewHolder, int position) {
        if (isSectionHeaderPosition(position)) {
            ((SectionViewHolder) sectionViewHolder).title.setText(mSections.get(position).getGithubUser().getLogin());
            ((SectionViewHolder) sectionViewHolder).repoCount.setText(mSections.get(position).getGithubUser().getPublic_repos());
            ((SectionViewHolder) sectionViewHolder).realName.setText(mSections.get(position).getGithubUser().getName());
        } else {
    ...
    public static class Section {
        ...
        public Section(int firstPosition, GithubUser gitUser) {
